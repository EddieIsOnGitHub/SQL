...
FROM 'C:\Code College\bootcamp\SQL\My_corse_code\Chapter_08\pls_fy2014_pupld14a.csv'
WITH (FORMAT CSV, HEADER);


COPY pls_fy2009_pupld14a
FROM 'C:\Code College\bootcamp\SQL\My_corse_code\Chapter_08\pls_fy2014_pupld14a.csv'
WITH (FORMAT CSV, HEADER);
...
FROM 'C:\Code College\bootcamp\SQL\My_corse_code\Chapter_08\pls_fy2009_pupld09a.csv'
WITH (FORMAT CSV, HEADER);
