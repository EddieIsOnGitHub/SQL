...
FROM 'C:\Code College\bootcamp\SQL\My_corse_code\Chapter_10\acs_2011_2015_stats.csv'
...
FROM 'C:\Code College\bootcamp\SQL\My_corse_code\Chapter_10\fbi_crime_data_2015.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
